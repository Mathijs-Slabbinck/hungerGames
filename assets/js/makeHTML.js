...
function GenerateDistricts(beforeGame = true) {
    ...
    if (beforeGame) {
        $container.append(`
            <div class="row align-items-center"><p class="col-10" id="skipIntroText">Skip intro? (not recommended)</p><button type="button" class="col-2" id="skipIntro">NO</button></div>
